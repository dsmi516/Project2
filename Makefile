...
SOURCES := assign2.cpp SystemHandler.cpp BuildingManager.cpp FloorManager.cpp BuildingUI.cpp FloorUI.cpp BaseUI.cpp BuildingModel.cpp FloorModel.cpp NamedEntity.cpp RoomModel.cpp RoomManager.cpp RoomUI.cpp
